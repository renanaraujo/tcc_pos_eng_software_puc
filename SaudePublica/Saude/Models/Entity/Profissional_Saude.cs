...
namespace Saude.Models.Entity
{
	...
	public class Profissional_Saude
	{
		...
		[DisplayName("Tipo de cargo de profissional de saúde")]
		[Required(ErrorMessage = "Tipo de cargo de profissional de saúde é obrigatório")]
		public int Tipo_Cargo_Profissional_Saude_Id { get; set; }
	}
}
